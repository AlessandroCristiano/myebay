	   ...
	   <body class="d-flex flex-column h-100">
			...
			<main class="flex-shrink-0">
			  <div class="container">
					...
					<spring:hasBindErrors  name="show_utente_attr">
						<%-- alert errori --%>
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form:form modelAttribute="show_utente_attr" method="post" action="reset" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									...
									<spring:bind path="vecchiaPassword">
										<input type="text" class="form-control ${status.error ? 'is-invalid' : ''}" name="vecchiaPassword" id="vecchiaPassword" placeholder="Inserire Vecchia Password" required>
									</spring:bind>
