...
public class SecSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
         ...
         .antMatchers("/login","/","/home","/annuncio/list","/utente/registrazione","/utente/saveRegistrazione","/annuncio/show/{idAnnuncio}","/acquisto/acquistaWithoutAuth","/acquistaWithoutAuth").permitAll()
